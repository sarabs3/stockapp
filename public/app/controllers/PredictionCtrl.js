...
}).controller('PredictionController',['$scope','$http', '$location', '$window', 'DTOptionsBuilder', 'DTColumnDefBuilder' , function($scope, $http, $location , $window , DTOptionsBuilder , DTColumnDefBuilder ){
